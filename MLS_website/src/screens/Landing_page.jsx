  ...
  return (
    <>
      <div className="h-screen w-full">
        <Header />
        <div className="absolute -z-10 top-0 h-screen   w-full object-cover object-center overflow-hidden ">
          <video
            autoPlay
            playsInline
            loop
      ...
      {/* ignite your dreams/ */}
      <div className="w-full bg-red-300 flex justify-center flex-col items-center md:py-10 md:px-8">
        <motion.h1
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          className="text-3xl py-2 md:text-6xl tracking-wider italic font anima"
        >
          Ignite Your Dreams
        </motion.h1>
        <h2 className="md:px-16 flex flex-wrap pt-2 pb-5 px-3 md:py-4 font-semibold text-center text-sm md:text-2xl">
      ...
      <div className="relative w-full md:h-screen h-96">
        <div className="w-full h-full md:h-screen object-contain">
          <img
        ...
        <div className="absolute z-10 h-full md:h-screen top-0 w-full  flex md:flex-row items-end md:items-end  flex-row   md:bg-transparent ">
          <div className="  md:pb-36  px-5 md:px-40 md:inline-block  h-[40%] w-[80%]">
            <h1 className=" hover:bg-slate-900 hover:p-3 hover:scale-110 transition-all ease-linear text-xl backdrop-blur-lg hover:rounded-2xl hover:text-white  text-white tracking-wider  md:text-4xl">
      ...
      {/* cardss */}
      <div className="w-full  bg-red-300 flex flex-col justify-center items-center text-3xl text-black md:text-6xl">
        <h1 className="tracking-wider py-6 md:py-20">Love at First Sight</h1>
      </div>
      ...
      <div className="w-full md:h-screen gap-8  bg-red-300 md:flex px-6 items-center">
        <div className="md:w-[50%] w-full md:pl-8 md:pt-32 h-[70%] ">
          <h1 className="md:text-4xl text-2xl lg:text-6xl   font-bold">
            Matrix
          </h1>
          <h1 className="w-[100%] md:mt-4 mt-2 lg:text-2xl md:text-xl">
          ...
          <button className="bg-black text-white md:px-6 lg:px-8 lg:py-3 md:mt-4 my-3 md:py-2">
            - Shop chains -
          </button>
        </div>
      ...
      <div className="w-full py-3    bg-red-300">
        <div className="md:h-28 bg-red-300 flex items-center justify-center">
          <h1 className="md:text-6xl text-4xl py-4">Shop by Category</h1>
        </div>
      ...
      <div className="w-full py-4 md:pt-3 bg-red-300 px-4">
        <div className=" md:py-4 flex items-center justify-center">
          <h1 className="md:text-4xl font-bold tracking-wider">World of MLS</h1>
        </div>
        <div className=" flex md:py-4 py-3 items-center justify-center">
