  ...
  return (
    ...
    >
      <g id="SVGRepo_bgCarrier" stroke-width="0">
        <path
          transform="translate(-15.36, -15.36), scale(33.92)"
          fill="#914042"
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <path
            style={{ fill: "#DE9900" }}
            d="M181.072,509.659c-25.254,0-49.693-5.084-72.639-15.111c-3.919-1.713-5.707-6.277-3.995-10.196 c1.713-3.918,6.277-5.707,10.196-3.995c20.979,9.168,43.332,13.817,66.438,13.817c91.303,0,165.585-74.02,165.585-165.003 c0-9.11-0.752-18.252-2.234-27.169c-0.701-4.219,2.15-8.208,6.369-8.908c4.216-0.702,8.207,2.151,8.908,6.37 c1.622,9.755,2.443,19.75,2.443,29.709C362.143,428.692,280.915,509.659,181.072,509.659z"
          ></path>{" "}
          <path
             style={{ fill: "#DE9900" }}
            d="M252.811,36.329c-2.832,0-5.559-1.558-6.92-4.259c-1.926-3.819-0.391-8.475,3.428-10.4 c25.443-12.826,52.9-19.33,81.61-19.33c25.252,0,49.69,5.084,72.638,15.112c3.919,1.713,5.707,6.278,3.995,10.196 c-1.714,3.918-6.279,5.707-10.196,3.995c-20.979-9.168-43.333-13.817-66.437-13.817c-26.267,0-51.378,5.947-74.638,17.671 C255.172,36.063,253.982,36.329,252.811,36.329z"
          ></path>{" "}
          <path
